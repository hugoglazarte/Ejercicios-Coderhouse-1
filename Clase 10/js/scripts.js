...
var Imdb = (function () {
    ...
    var dibujarPelicula = function (pelicula) {
        ...
        var butBorrar = document.createElement('button');
        var butTxtBorrar = document.createTextNode('Borrar Pelicula');

        var butEditar = document.createElement('button');
        var butTxtEditar = document.createTextNode('Editar Pelicula');
        ...
        butBorrar.setAttribute('id','boton-ID-'+pelicula.id);
        butBorrar.setAttribute('class', 'btn-borrar btn btn-default');
        // butBorrar.setAttribute('style','display:block;');

        butEditar.setAttribute('id','editar-ID-'+pelicula.id);
        butEditar.setAttribute('class', 'btn-borrar btn btn-default');
        // butEditar.setAttribute('style','display:block;');


        butBorrar.onclick = function () {
        	// debugger;
        ...
        butBorrar.appendChild(butTxtBorrar);
        butEditar.appendChild(butTxtEditar);
        ...
        li.appendChild(p);
        li.appendChild(img);
        li.appendChild(butBorrar);
        li.appendChild(butEditar);
	...
	var editarPelicula = function (pelicula) {

		var posicionArray = buscarPosicion(pelicula);

		function traerContenidos() {

			var peliculaEnArray = peliculas[posicionArray];
